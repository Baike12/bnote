//! Generated by gen_glyphdata.py — do not edit by hand.
//! AGL subset (full official Adobe Glyph List), Unicode→LaTeX math table,
//! and TeX Computer-Modern charcode→LaTeX tables (cmmi/cmsy/cmex/cmr).

/// Adobe Glyph List: glyph name → unicode string (sorted by name).
pub static AGL: &[(&str, &str)] = &[
    ("A", "A"),
    ("AE", "\u{00C6}"),
    ("AEacute", "\u{01FC}"),
    ("AEmacron", "\u{01E2}"),
...
/// Unicode codepoint → LaTeX body (sorted by codepoint).
pub static UNI2LATEX: &[(u32, &str)] = &[
    (0x00A0, " "),
    (0x00A8, "\\ddot{}"),
    (0x00AD, "-"),
    (0x00AF, "\\bar{}"),
    ...
    (0x20DC, "\\ddddot{}"),
    (0x2102, "\\mathbb{C}"),
    (0x2103, "^{\\circ}\\mathrm{C}"),
    (0x2109, "^{\\circ}\\mathrm{F}"),
    (0x210A, "\\mathscr{g}"),
    (0x210B, "\\mathscr{H}"),
    (0x210D, "\\mathbb{H}"),
    (0x210F, "\\hbar"),
    ...
    (0x21BE, "\\upharpoonleft"),
    (0x21BF, "\\upharpoonright"),
    (0x21C0, "\\rightharpoonup"),
    (0x21C1, "\\rightharpoondown"),
    (0x21C2, "\\downharpoonleft"),
    (0x21C3, "\\downharpoonright"),
    (0x21C4, "\\rightleftarrows"),
    (0x21C6, "\\rightleftarrows"),
...
pub fn cm_slot_latex(font: u8, code: u8) -> Option<&'static str> {
    let key: u16 = ((font as u16) << 8) | code as u16;
    CM_SLOTS
...
/// Resolves an Adobe glyph name to a unicode string via the AGL table.
pub fn agl_lookup(name: &str) -> Option<&'static str> {
    AGL.binary_search_by(|(k, _)| (*k).cmp(name)).ok().map(|i| AGL[i].1)
}

/// Maps a unicode math codepoint to its LaTeX body (without surrounding $).
pub fn uni_to_latex(cp: u32) -> Option<&'static str> {
    UNI2LATEX
